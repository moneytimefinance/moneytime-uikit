...
var getFontSize = function (_a) {
    ...
    return small ? "18px" : fontSize || "20px";
};
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React__default['default'].createElement(InactiveButton, __assign({ forwardedAs: as, variant: "tertiary", colorKey: variant === variants.PRIMARY ? "primary" : "card" }, props)));
    }
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 160 40" }, props),
        React__default['default'].createElement("image", { width: "160", height: "40", href: "/images/MoneytimeLogoM.svg" })));
};
...
var templateObject_1$I, templateObject_2$f, templateObject_3$7, templateObject_4$3, templateObject_5$2;
