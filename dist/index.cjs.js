...
var Icon$r = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/moneycoin.svg" })));
};
...
var Icon$y = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: "90", height: "90", href: "/images/moneycoin.svg" })));
};
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React__default['default'].createElement(InactiveButton, __assign({ forwardedAs: as, variant: "tertiary", colorKey: variant === variants.PRIMARY ? "primary" : "text" }, props)));
    }
...
var RadiousImage = styled__default['default'].img(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  border-radius: 50%;\n"], ["\n  border-radius: 50%;\n"])));
var Spinner = function (_a) {
    _a.size;
    return (React__default['default'].createElement(Container$1, null,
        React__default['default'].createElement(RadiousImage, { src: "/images/spinner.gif", alt: "loading..." })));
};
...
var Icon$P = function (props) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("image", { width: "24", height: "24", href: url })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 160 40" }, props),
        React__default['default'].createElement("image", { width: "160", height: "40", href: logoUrl })));
};
...
var Logo$1 = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        isPushed ? (React__default['default'].createElement(LogoWithText, { className: "desktop-icon", isDark: isDark })) : (React__default['default'].createElement(React__default['default'].Fragment, null))));
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush }, isPushed ? (React__default['default'].createElement(Icon$S, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$R, { width: "24px", color: "textSubtle" }))),
...
var CakePrice = function (_a) {
    ...
    return moneyPriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://pancakeswap.info/token/0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
        React__default['default'].createElement(Icon$y, { width: "24px", mr: "8px" }),
        React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + moneyPriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            React__default['default'].createElement(CakePrice$1, { moneyPriceUsd: moneyPriceUsd }),
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, moneyPriceUsd: moneyPriceUsd, pushNav: setIsPushed, links: links }),
