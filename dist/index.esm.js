...
var getFontSize = function (_a) {
    ...
    return small ? "18px" : fontSize || "18px";
};
...
var Icon$r = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/moneycoin.svg" })));
};
...
var Icon$y = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: "90", height: "90", href: "/images/moneycoin.svg" })));
};
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, variant: "tertiary", colorKey: variant === variants.PRIMARY ? "primary" : "text" }, props)));
    }
...
styled(Icon$O)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
styled(Icon$N)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var RadiousImage = styled.img(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  border-radius: 50%;\n"], ["\n  border-radius: 50%;\n"])));
var Spinner = function (_a) {
    _a.size;
    return (React.createElement(Container$1, null,
        React.createElement(RadiousImage, { src: "/images/spinner.gif", alt: "loading..." })));
};
var templateObject_1$u, templateObject_2$8, templateObject_3$2, templateObject_4$1, templateObject_5, templateObject_6;
...
var Icon$P = function (props) {
    var url = "/images/menu/farmpool-icon.svg";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: url })));
};
...
var Icon$T = function (props) {
    var url = "/images/menu/dashboard-icon.svg";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: url })));
};
...
var Logo = function (_a) {
    ...
    var logoUrl = isDark ? "/images/MoneytimeLogoW.svg" : "/images/MoneytimeLogoM.svg";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 160 40" }, props),
        React.createElement("image", { width: "160", height: "40", href: logoUrl })));
};
...
var Icon$_ = function (props) {
    var url = "/images/menu/timepool-icon.svg";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: url })));
};

var Icon$$ = function (props) {
    var url = "/images/menu/moneyprinter-icon.svg";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: url })));
};

var Icon$10 = function (props) {
    var url = "/images/menu/docs-icon.svg";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: url })));
};

var Icon$11 = function (props) {
    var url = "/images/menu/audit-icon.svg";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: url })));
};

var Icon$12 = function (props) {
    var url = "/images/menu/stakepool-icon.svg";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: url })));
};
...
var Icon$16 = function (props) {
    var url = "/images/menu/exchange-icon.svg";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { width: "24", height: "24", href: url })));
};
...
var Icon$18 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 50 50" }, props),
        React.createElement("path", { d: "M45,4H5C4.448,4,4,4.448,4,5v40c0,0.552,0.448,1,1,1h40c0.552,0,1-0.448,1-1V5C46,4.448,45.552,4,45,4z M40,13.5 l-1.821,2.197C38.064,15.811,38,15.965,38,16.125V32.75c0,0.16,0.064,0.314,0.179,0.428L40,35.546V36H30v-0.454l2.821-2.368 C32.936,33.064,33,32.91,33,32.75V17.879L24.848,36h-0.001h-1.543l0,0L15,18.375v13.108c0,0.22,0.076,0.433,0.215,0.605L18,35.546 V36h-8v-0.454l2.783-3.438C12.923,31.936,13,31.721,13,31.5V16.388c0-0.142-0.05-0.279-0.142-0.388L11,13.5V13h7.097l7.624,16.183 L33.002,13H40V13.5z" })));
};
...
var Logo$1 = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        ...
        isPushed ? (React.createElement(LogoWithText, { className: "desktop-icon", isDark: isDark })) : (React.createElement(React.Fragment, null))));
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush }, isPushed ? (React.createElement(Icon$S, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$R, { width: "24px", color: "textSubtle" }))),
...
var MenuEntry = styled.div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (secondary ? "0 32px" : "0 14px");
}, function (_a) {
    var secondary = _a.secondary;
    return (secondary ? "14px" : "24px");
}, function (_a) {
...
var CakePrice = function (_a) {
    var moneyPriceUsd = _a.moneyPriceUsd;
    return moneyPriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.info/token/0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
        React.createElement(Icon$y, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + moneyPriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, moneyPriceUsd = _a.moneyPriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang;
    if (!isPushed) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            React.createElement(CakePrice$1, { moneyPriceUsd: moneyPriceUsd }),
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, moneyPriceUsd = _a.moneyPriceUsd, links = _a.links; _a.profile; var children = _a.children;
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, moneyPriceUsd: moneyPriceUsd, pushNav: setIsPushed, links: links }),
